...
// HasTechdomain applies the HasEdge predicate on the "techdomain" edge.
func HasTechdomain() predicate.Domain {
	return predicate.Domain(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(TechdomainTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, TechdomainTable, TechdomainColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasTechdomainWith applies the HasEdge predicate on the "techdomain" edge with a given conditions (other predicates).
func HasTechdomainWith(preds ...predicate.Tech) predicate.Domain {
	return predicate.Domain(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(TechdomainInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, TechdomainTable, TechdomainColumn),
		)
...
// HasKpidomain applies the HasEdge predicate on the "kpidomain" edge.
func HasKpidomain() predicate.Domain {
	return predicate.Domain(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(KpidomainTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, KpidomainTable, KpidomainColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasKpidomainWith applies the HasEdge predicate on the "kpidomain" edge with a given conditions (other predicates).
func HasKpidomainWith(preds ...predicate.Kpi) predicate.Domain {
	return predicate.Domain(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(KpidomainInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, KpidomainTable, KpidomainColumn),
		)
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
