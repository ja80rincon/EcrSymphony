...
const (
	// Label holds the string label denoting the kqicategory type in the database.
	Label = "kqi_category"
...
// Columns holds all SQL columns for kqicategory fields.
var Columns = []string{
	FieldID,
	FieldCreateTime,
	FieldUpdateTime,
