...
const (
	// Label holds the string label denoting the kqitemporalfrequency type in the database.
	Label = "kqi_temporal_frequency"
	...
	// Table holds the table name of the kqitemporalfrequency in the database.
	Table = "kqi_temporal_frequencies"
	...
	// KqiTemporalFrequencyFkInverseTable is the table name for the Kqi entity.
	// It exists in this package in order to avoid circular dependency with the "kqi" package.
	KqiTemporalFrequencyFkInverseTable = "kqis"
...
// Columns holds all SQL columns for kqitemporalfrequency fields.
var Columns = []string{
	FieldID,
	FieldCreateTime,
	FieldUpdateTime,
